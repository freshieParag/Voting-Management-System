                    ...
                    <div className="col-12 top-header">
                        ...
                        <div className="row pt-2">
                            ...
                            <div className="col-9 path bg-primar">
                                ...
                                <NavLink to='/verify-electors/rejected' id='path' style={{ color: 'black' }}>/verify-electors --- rejected</NavLink>
                            </div>
                            ...
                            <div className="col-12 p-1">
                                ...
                                <table className='table table-striped table-bordered table-responsive'>
                                    <thead className="">
                                        <tr>
                                            <th scope="col">#</th>
                                            <th scope="col">Firsdssct</th>
                                            <th scope="col">Last</th>
                                            <th scope="col">Hacdcscle</th>
                                            <th scope="col">Fidst</th>
                                            <th scope="col">Ladsst</th>
                                            <th scope="col">Hdcsandle</th>
                                            <th scope="col">Fdscirst</th>
                                            <th scope="col">Lafdfst</th>
                                            <th scope="col">Hafdvfndle</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
